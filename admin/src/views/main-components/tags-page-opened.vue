...
export default {
    ...
    computed: {
        title () {
            return this.$store.state.page.currentTitle;
        },
        tagsList () {
            return this.$store.state.page.pageOpenedList;
        }
    },
    methods: {
        itemTitle (item) {
        ...
        closePage (event, name) {
            let pageOpenedList = this.$store.state.page.pageOpenedList;
            ...
            pageOpenedList = this.$store.state.page.pageOpenedList;
